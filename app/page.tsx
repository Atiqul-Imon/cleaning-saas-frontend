        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-[var(--gray-600)] max-w-2xl mx-auto">
              Powerful tools designed specifically for cleaning businesses to streamline operations
              and grow faster.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group p-8 bg-gradient-to-br from-[var(--primary-50)] to-white rounded-2xl border border-[var(--primary-100)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[var(--gray-600)] leading-relaxed">
                Keep track of all your clients, their preferences, access details, and service
            ...
            <div className="group p-8 bg-gradient-to-br from-[var(--accent-50)] to-white rounded-2xl border border-[var(--accent-100)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[var(--gray-600)] leading-relaxed">
                Schedule one-off or recurring jobs with automatic generation for weekly, bi-weekly,
                or monthly cleaning.
              </p>
            </div>
            ...
            <div className="group p-8 bg-gradient-to-br from-[var(--success-50)] to-white rounded-2xl border border-[var(--success-100)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[var(--gray-600)] leading-relaxed">
                Upload before/after photos with automatic timestamps. Works offline and syncs when
                you&apos;re back online.
              </p>
            </div>
            ...
            <div className="group p-8 bg-gradient-to-br from-[var(--warning-50)] to-white rounded-2xl border border-[var(--warning-100)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[var(--gray-600)] leading-relaxed">
                Automatically generate professional invoices on job completion with tax calculation
            ...
            <div className="group p-8 bg-gradient-to-br from-[var(--primary-50)] to-white rounded-2xl border border-[var(--primary-100)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[var(--gray-600)] leading-relaxed">
                Track payments, send automated reminders via email or SMS, and mark payments
                manually for bank transfers.
              </p>
            </div>
            ...
            <div className="group p-8 bg-gradient-to-br from-[var(--accent-50)] to-white rounded-2xl border border-[var(--accent-100)] hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[var(--gray-600)] leading-relaxed">
                Works perfectly on mobile devices with offline support. Install as a PWA for an
                app-like experience.
              </p>
            </div>
          </div>
            ...
            {[
              {
                step: '1',
                title: 'Schedule Jobs',
                desc: 'Create one-time or recurring cleaning jobs with ease',
              },
              {
                step: '2',
                title: 'Complete Work',
                desc: 'Finish the job and upload proof photos on-site',
              },
              {
                step: '3',
                title: 'Auto Invoice',
                desc: 'Invoices are automatically generated and sent to clients',
              },
              {
                step: '4',
                title: 'Get Paid',
                desc: 'Track payments and send reminders until you get paid',
              },
            ].map((item, index) => (
      ...
      <section className="py-20 sm:py-24 lg:py-32 bg-gradient-to-br from-[var(--primary-600)] via-[var(--primary-700)] to-[var(--accent-600)] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl mb-10 text-white/90 max-w-2xl mx-auto">
            Join thousands of cleaning professionals who trust Clenvora to manage their business
