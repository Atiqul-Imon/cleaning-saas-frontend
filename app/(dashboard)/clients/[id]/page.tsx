              ...
              <div className="mt-8 pt-8 border-t border-[var(--gray-200)]">
                ...
                <Card variant="outlined" padding="md" className="bg-[var(--gray-50)]">
                  <Stack spacing="md">
                    {client.notes.keySafe && (
                      <div>
                        <span className="text-sm font-bold text-[var(--gray-700)] uppercase tracking-wide">
                          Key Safe:
                        </span>
                        <p className="text-[var(--gray-900)] font-medium mt-1">
                          {client.notes.keySafe}
                        </p>
                      </div>
                    )}
                  ...
                  <Card variant="outlined" padding="md" hover>
                    <Stack direction="row" justify="between" align="center">
                      <div>
                        ...
                        {job.scheduledTime && (
                          <p className="text-sm text-[var(--gray-600)] font-medium mt-1">
                            {job.scheduledTime}
                          </p>
                        )}
                      </div>
