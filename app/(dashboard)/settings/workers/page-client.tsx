...
import { Card, Button, Input, Badge, Avatar, Modal, LoadingSkeleton } from '@/components/ui';
            ...
            <div className="max-w-md mx-auto space-y-4">
              ...
              <div>
                ...
                <p className="text-[var(--gray-600)] mb-6">
                  Only business owners can manage staff.
                </p>
                <a href="/dashboard">
          ...
          {queryError && cleaners.length === 0 && (
            ...
            >
              <Stack direction="row" spacing="sm" align="center">
                ...
                <span className="text-sm text-[var(--error-700)] font-semibold">{queryError}</span>
              </Stack>
            </Card>
          )}
          ...
          {cleaners.length === 0 ? (
            <Card variant="elevated" padding="lg" className="text-center">
              <div className="max-w-md mx-auto space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[var(--gray-900)] mb-2">No staff yet</h3>
                  <p className="text-[var(--gray-600)] mb-6">
