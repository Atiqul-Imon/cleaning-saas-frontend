      ...
      <Link href={`/jobs/${id}`}>
        <Card variant="elevated" padding="md" hover className={cn('border-l-4', config.color)}>
          <div className="mb-3">
            ...
            >
              <Stack direction="row" spacing="md" align="start" className="flex-1 min-w-0">
                <Avatar name={client.name} size="md" />
                <div className="flex-1 min-w-0 overflow-hidden">
                  <h3 className="font-bold text-[var(--gray-900)] text-lg mb-1 truncate">
                    {client.name}
                  </h3>
                  ...
                  <Stack
                    ...
                    spacing="sm"
                    align="center"
                    className="text-[var(--gray-600)] flex-wrap"
                  >
                    <svg
                    ...
                    {scheduledTime && (
                      <>
                        <span className="text-[var(--gray-400)] hidden sm:inline">•</span>
                        <svg
                          className="w-4 h-4 flex-shrink-0"
                          fill="none"
                          stroke="currentColor"
              ...
              <div className="flex-shrink-0 sm:ml-4">
                <Badge variant={config.variant} size="md" className="whitespace-nowrap">
                  {status.replace('_', ' ')}
                </Badge>
              </div>
            </Stack>
          ...
          {cleaner && (
            <div
              className={cn(
                'mt-3 pt-3 border-t border-[var(--gray-200)]',
                config.bg,
            ...
            >
              <Stack direction="row" spacing="sm" align="center">
                ...
                <span className="text-sm text-[var(--gray-700)] font-medium">
                  Assigned to: {cleaner.email}
                </span>
              </Stack>
            </div>
          )}
